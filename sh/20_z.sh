# Copyright (c) 2014 Fernando Carmona Varo
...
#         . /path/to/z.sh
#     * Add this line to your PROMPT_COMMAND or similar hook:
#         _z --add $(pwd)
...
#         set $_Z_EXCLUDE_DIRS to a colon-separated list of folders to exclude.
#
# USE:
